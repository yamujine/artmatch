...
defined('EXHIBITION_APPLICABLE') OR define('EXHIBITION_APPLICABLE', '1');
defined('EXHIBITION_NOT_APPLICABLE') OR define('EXHIBITION_NOT_APPLICABLE', '0');

defined('EXHIBITION_NOT_STARTED') OR define('EXHIBITION_NOT_STARTED', '0');
defined('EXHIBITION_NOW_EXHIBITING') OR define('EXHIBITION_NOW_EXHIBITING', '1');
defined('EXHIBITION_END') OR define('EXHIBITION_END', '2');
