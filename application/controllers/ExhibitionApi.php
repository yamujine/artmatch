...
class ExhibitionApi extends API_Controller {
    ...
    public function accept() {
        ...
        $already_accepted_artwork_ids_objects = $this->exhibition_model->get_artwork_ids_by_exhibition_id($exhibition_id);
        $already_accepted_artwork_ids = array_map(function ($value) {
            return $value->artwork_id;
        }, $already_accepted_artwork_ids_objects);
        $applied_artwork_ids = array_diff($applied_artwork_ids, $already_accepted_artwork_ids);
