...
class Apply_model extends CI_Model {
    ...
    public function get_by_exhibition_id($exhibition_id) {
        return $this->db
    ...
    public function get_users_with_artworks_by_exhibition_id($exhibition_id) {
        return $this->db
            ->select('artworks.*, apply.status AS apply_status, apply.reason AS apply_reason, users.user_name, users.email')
            ->from(self::TABLE_NAME)
            ->join('artworks', 'apply.artwork_id = artworks.id')
    ...
    public function get_by_user_id_and_exhibition_id($user_id, $exhibition_id) {
        return $this->db
            ->select('artworks.*, apply.status AS apply_status, apply.reason AS reason, apply.id AS apply_id')
            ->from('artworks')
